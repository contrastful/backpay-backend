 ...
 */
final class Version20201003154825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE place ADD cover_image_id INT DEFAULT NULL, DROP cover_image');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE place ADD cover_image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP cover_image_id');
    }
}
